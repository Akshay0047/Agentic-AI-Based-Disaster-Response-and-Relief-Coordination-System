        ...
        <tbody>
          {tableRows.map((v) => (
            <tr key={v.id} style={{ borderBottom: "1px solid #fff" }}>
              <td style={{ padding: "4px 8px", border: "1px solid #ccc" }}>{v.id}</td>
              ...
              <td style={{
                ...
                background: v.availability_status === "available" ? "#d4edda" : v.availability_status === "busy" ? "#fff3cd" : "#f8d7da",
                color: v.availability_status === "available" ? "#155724" : v.availability_status === "busy" ? "#856404" : "#721c1e",
              }}>{v.availability_status}</td>
              <td style={{ padding: "4px 8px", border: "1px solid #ccc" }}>{v.current_workload ?? 0}</td>
            </tr>
          ))}
        </tbody>
      </table>
